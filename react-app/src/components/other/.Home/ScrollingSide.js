                ...
                <article className="imagesToBe">
                    <header className="zeHead">
                        <div className="HighlightedOuterCircle">
                            <div>
                                {/* <canvas className="circleforPicture">
